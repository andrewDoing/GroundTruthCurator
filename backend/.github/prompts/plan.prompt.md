...
Keep it SIMPLE. We need initial working versions. Avoid over-engineering.

Write a short overview of what you are about to do.
Write function names and 1-3 sentences describing their purpose.
Write test names and 5-10 words about behavior to cover.

DO NOT edit any code!
Write your plan to /plans/*-plan.md where * is a short description of the plan.